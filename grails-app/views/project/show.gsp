	...
	<body>
		...
		<div id="show-project" class="content scaffold-show" role="main">
			...
			<ol class="property-list project">
				...
				<g:if test="${projectInstance?.workers}">
				<li class="fieldcontain">
					<span id="workers-label" class="property-label"><g:message code="project.workers.label" default="Workers" /></span>
					
						<g:each in="${projectInstance.workers}" var="w">
						<span class="property-value" aria-labelledby="workers-label"><g:link controller="employee" action="show" id="${w.id}">${w?.encodeAsHTML()}</g:link></span>
						</g:each>
